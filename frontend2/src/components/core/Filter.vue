  ...
  >
    ...
    <v-card>
      <v-container grid-list-xl>
        <v-layout wrap>
          <v-flex xs12>
            <div class="text-xs-center body-2 text-uppercase sidebar-filter">Color de barra lateral</div>
          ...
          <v-flex
            xs12
          >
            <div class="text-xs-center body-2 text-uppercase sidebar-filter">Imágenes de fondo</div>
          </v-flex>
          <v-flex
            v-for="img in images"
            :key="img"
